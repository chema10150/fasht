...
require("lazy").setup({
	...
	{ -- Highlight, edit, and navigate code
		...
		config = function()
			...
			require("nvim-treesitter.configs").setup({
				ensure_installed = { "bash", "c", "html", "lua", "markdown", "vim", "vimdoc", "yaml", "latex", "zig" },
	...
	{ "mbbill/undotree", vim.keymap.set("n", "<leader>uu", ":UndotreeShow<CR>", { silent = true }) },

	{
		...
		vim.keymap.set("n", "<leader>lw", ":VimtexWordCount<CR>", { silent = true }),
...

	{
		...
		config = function()
			require("chatgpt").setup({
				api_key_cmd = "cat /home/chema/apikey.txt",
				openai_params = {
					model = "gpt-4o",
				},
			})
...

	{
		...
		opts = {
			...
			host = "192.168.0.31", -- The host running the Ollama service.
	...
	vim.keymap.set("n", "<leader>z", function()
		require("zen-mode").toggle({
			-- you can put specific options here
		})
