...
root_partition = disk.PartitionModification(
	...
	length=disk.Size(64, disk.Unit.GiB, device.device_info.sector_size),
	mountpoint=None,
	fs_type=fs_type,
	mount_options=[],
)
...
with Installer(
    ...
    installation.minimal_installation(hostname='laptop')
installation.add_additional_packages(['nano', 'wget', 'git', 'fastfetch', 'basedevel', 'gbd', 'xorg',
                                      'ansible', 'curl', 'wget', 'go', 'openssh'])
...
user = models.User('chema', 'password', True)
